...
const AppHeader = props => {
    ...
    return (
        <Header className='header'>
            ...
            <div className='right'>
                <div className='mr15'>
                    <a rel='noopener noreferrer' href='https://github.com/og-ss/react-admin.git/react-admin' target='_blank'>
                        <Icon type='github' style={{ color: '#000' }} />
                    </a>
                </div>
                <div className='mr15'>
                    <Badge dot={true} offset={[-2, 0]}>
                        <a href='https://github.com/og-ss/react-admin.git/react-admin' style={{ color: '#000' }}>
                            <Icon type='bell' />
                        </a>
                    </Badge>
                </div>
